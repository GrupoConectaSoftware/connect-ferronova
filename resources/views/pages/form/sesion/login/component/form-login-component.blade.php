...
<div>
    ...
    <form class="space-y-3">
        ...
        <div>
            <div class="flex items-center justify-between">
                ...
                <a href="#" class="text-xs text-ferro-yellow-500 hover:text-ferro-yellow-700 font-medium transition-colors font-body" style="font-family: var(--font-body);">
        ...
        {{-- RECORDARME --}}
        <div class="flex items-center justify-between">
            <label class="flex items-center gap-2 text-sm text-ferro-steel-600 font-body cursor-pointer" style="font-family: var(--font-body);">
                <input type="checkbox" class="w-4 h-4 rounded border-ferro-carbon-300 text-ferro-yellow-500 focus:ring-ferro-yellow-500">
                Recordarme
            </label>
        </div>
    ...
    <p class="text-center text-sm text-ferro-steel-500 font-body mt-4" style="font-family: var(--font-body);">
        ...
        <a href="{{ route('register') }}" class="text-ferro-yellow-500 hover:text-ferro-yellow-700 font-medium transition-colors">
            Regístrate Aquí
        </a>
    </p>
