...
<section class="relative z-10 w-full h-140 lg:h-162.5 overflow-hidden bg-ferro-carbon-900" aria-labelledby="hero-title">
    ...
    <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-2 h-full flex items-center">
        <header class="max-w-4xl text-ferro-white space-y-6 pt-12 lg:pt-32">
            <hgroup>
                <h1 id="hero-title" class="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight drop-shadow-sm">
                    Construimos <span class="text-ferro-yellow-500">confianza</span>,<br> herramienta a herramienta
                </h1>
                <p class="mt-4 text-base sm:text-lg text-ferro-steel-300/90 font-description max-w-lg leading-relaxed">
                    Más de 10.000 referencias en stock. Tu aliado industrial en venta y alquiler de maquinaria para construcción y mantenimiento.
                </p>
            </hgroup>

            <nav aria-label="Acciones" class="flex flex-wrap gap-4 pt-2">
                <a href="#about-us" class="bg-ferro-yellow-500 hover:bg-ferro-yellow-600 text-ferro-black font-medium px-6 py-3 rounded-xl transition-all duration-300 shadow-lg shadow-ferro-yellow-500/25">
                    Conócenos
                </a>
