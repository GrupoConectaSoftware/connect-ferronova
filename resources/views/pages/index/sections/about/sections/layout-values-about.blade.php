...
<section class="relative w-full py-20 lg:py-32 bg-ferro-background overflow-hidden" aria-label="Valores corporativos">
    ...
    <div
        class="absolute inset-0 bg-[linear-gradient(to_right,#0F172A07_1px,transparent_1px),linear-gradient(to_bottom,#0F172A07_1px,transparent_1px)] bg-size-[44px_44px] pointer-events-none z-0">
    </div>
    ...
    <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-full">
        ...
        <div class="max-w-360 mx-auto">
            ...
            <div class="max-w-2xl mb-10">
                <span
                    class="inline-flex items-center gap-2 text-ferro-carbon-500 font-mono font-medium text-[11px] uppercase tracking-[0.25em] mb-5">
                    <span class="w-6 h-px bg-ferro-yellow-500"></span>
                    Lo que nos define
                </span>
                <h2
                    class="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-ferro-carbon-900 tracking-tight leading-[1.05] mb-4">
                ...
                <p class="font-description text-ferro-steel-500 text-base lg:text-lg leading-relaxed">
                    Cuatro compromisos y una trayectoria que respaldan cada entrega, cada asesoría y cada obra que
                    confía en nosotros.
                </p>
            </div>
            ...
            <div
                class="h-6 mb-10 lg:mb-14 bg-[repeating-linear-gradient(90deg,#0F172A_0,#0F172A_1px,transparent_1px,transparent_40px)] opacity-[0.08]">
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-3 gap-5 lg:gap-6 lg:auto-rows-fr">
                ...
                <div
                    ...
                    <span
                        class="absolute top-7 right-9 font-mono text-[10px] tracking-widest text-ferro-white/50 uppercase">Ref.
                        inventario</span>

                    <div class="absolute bottom-7 lg:bottom-8 left-7 lg:left-8 right-7 lg:right-8 text-ferro-white">
                        <span
                            class="inline-block bg-ferro-yellow-500 text-ferro-black font-heading font-bold text-xs uppercase tracking-widest px-3 py-1 rounded-full mb-3">
                            +10.000 SKU activos
                        </span>
                        ...
                        <a href="#"
                            class="inline-flex items-center gap-1.5 font-heading font-bold text-sm text-ferro-yellow-500 hover:text-ferro-white transition-colors">
                ...
                <div
                    class="lg:col-span-3 lg:row-span-1 bg-ferro-white rounded-[28px] p-7 ring-1 ring-ferro-carbon-900/5 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_16px_32px_-16px_rgba(15,23,42,0.10)] hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(15,23,42,0.04),0_24px_40px_-16px_rgba(15,23,42,0.14)] transition-all duration-300 flex flex-col justify-between min-h-40 lg:min-h-0">
                    <div class="flex items-start justify-between">
                        <svg class="w-8 h-8 text-ferro-carbon-900" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
                            <path
                                d="M12 2.25l2.6 5.27 5.82.85-4.21 4.1 1 5.8L12 15.9l-5.21 2.37 1-5.8-4.21-4.1 5.82-.85L12 2.25z" />
                        </svg>
                        <span class="font-mono text-[10px] uppercase tracking-widest text-ferro-steel-500">Ref.
                            Cal</span>
                    </div>
                    <div>
                ...
                <div
                    class="lg:col-span-4 lg:row-span-1 bg-ferro-yellow-500 rounded-[28px] p-7 shadow-[0_16px_32px_-12px_rgba(250,204,21,0.5)] flex flex-col justify-between text-ferro-black min-h-40 lg:min-h-0">
                    <span
                        class="font-mono text-[11px] uppercase tracking-[0.2em] text-ferro-black/60">Trayectoria</span>
                    <div>
                ...
                <div
                    class="lg:col-span-4 lg:row-span-1 bg-ferro-carbon-900 rounded-[28px] p-7 shadow-[0_16px_32px_-16px_rgba(2,6,23,0.5)] hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between min-h-42.5 lg:min-h-0">
                    <div class="flex items-start justify-between">
                        <svg class="w-8 h-8 text-ferro-yellow-500" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-ferro-steel-300 font-description leading-relaxed">
                            Asesoría técnica humana y cercana en cada proyecto, sin intermediarios ni respuestas
                            automáticas.
                        </p>
                    </div>
                </div>
                ...
                <div
                    class="lg:col-span-3 lg:row-span-1 bg-ferro-white rounded-[28px] p-7 ring-1 ring-ferro-carbon-900/5 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_16px_32px_-16px_rgba(15,23,42,0.10)] hover:-translate-y-1 hover:shadow-[0_1px_2px_rgba(15,23,42,0.04),0_24px_40px_-16px_rgba(15,23,42,0.14)] transition-all duration-300 flex flex-col justify-between min-h-42.5 lg:min-h-0">
                    <div class="flex items-start justify-between">
                        <svg class="w-8 h-8 text-ferro-carbon-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="3" y="16" width="5" height="5" rx="1" />
                            <rect x="9.5" y="11" width="5" height="10" rx="1" />
                            <rect x="16" y="6" width="5" height="15" rx="1" />
                            <line x1="3" y1="18.5" x2="8" y2="18.5" />
                            <line x1="9.5" y1="14.3" x2="14.5" y2="14.3" />
                            <line x1="9.5" y1="17.7" x2="14.5" y2="17.7" />
                            <line x1="16" y1="9.75" x2="21" y2="9.75" />
                            <line x1="16" y1="13.5" x2="21" y2="13.5" />
                            <line x1="16" y1="17.25" x2="21" y2="17.25" />
                        </svg>
                        <span class="font-mono text-[10px] uppercase tracking-widest text-ferro-steel-500">Ref.
                            Esc</span>
                    </div>
                ...
                <div
                    class="lg:col-span-6 lg:row-span-1 bg-ferro-carbon-900 rounded-[28px] p-7 lg:p-8 shadow-[0_16px_32px_-16px_rgba(2,6,23,0.5)] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 min-h-35 lg:min-h-0">
                    <div>
                        <h4 class="font-heading text-xl lg:text-2xl font-bold text-ferro-white mb-1.5">¿Listo para tu
                            próxima obra?</h4>
                    ...
                    <a href="#"
                        class="inline-flex items-center justify-center gap-2 bg-ferro-yellow-500 text-ferro-black font-heading font-bold text-sm px-5 py-3 rounded-full whitespace-nowrap hover:bg-ferro-yellow-300 transition-colors duration-300 shrink-0">
