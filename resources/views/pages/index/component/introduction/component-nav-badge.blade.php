...
<aside 
    ...
    aria-label="Aviso de cotización inmediata"
    role="complementary"
>
    ...
    {{-- ==========================================================
        ...
        ========================================================== --}}
    <a 
        href="https://wa.me/573184111790?text=Hola%20FERRANOVA!%20Quiero%20cotizar%20herramientas" 
        target="_blank"
    ...
    >
        ...
        <svg 
            class="w-2.5 h-2.5 sm:w-3 sm:h-3 group-hover:scale-110 transition-transform duration-300" 
            fill="currentColor" 
            viewBox="0 0 24 24"
            aria-hidden="true"
            role="img"
        ...
        <span class="hidden sm:inline-block text-[8px] sm:text-[10px] font-description font-bold text-ferro-whatsapp bg-white px-1.5 py-0.5 ml-1 rounded-full animate-pulse group-hover:text-white group-hover:bg-ferro-whatsapp/20 transition-colors duration-300">
            ● Disponible
        </span>
    </a>
