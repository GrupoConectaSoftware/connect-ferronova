...
>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 pb-6 border-b border-ferro-carbon-700">
            ...
            <div class="text-center sm:text-left">
                ...
                <ul class="space-y-1.5 text-[11px] sm:text-xs text-ferro-white font-body">
                    <li class="flex items-center justify-center sm:justify-start gap-1.5">
            ...
            <div class="text-center sm:text-left">
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-stretch gap-2 max-w-xs mx-auto sm:mx-0">
                    <input 
                        type="email" 
                ...
                {{-- REDES SOCIALES --}}
                <nav class="flex items-center justify-center sm:justify-start gap-3 mt-3" aria-label="Redes sociales de FERRANOVA">
