...
>
    ...
    <div class="relative w-full h-48 sm:h-56 md:h-64 overflow-hidden">
        <img 
            src="{{ asset('asset/sections/footer/imagenFerrofachada.webp') }}"
            alt="FERRANOVA - Fuerza industrial" 
            class="w-full h-full object-cover filter blur-[2px] scale-105 image-loading"
        ...
        <div class="absolute inset-0 flex items-center justify-start px-4 sm:px-10 lg:px-16">
            <div class="max-w-xl">
                <span class="text-ferro-yellow-500 text-[10px] sm:text-xs font-description font-bold uppercase tracking-[0.2em]">
                    Fuerza industrial
                </span>
                <h2 class="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-ferro-white leading-tight mt-1">
    ...
    {{-- ==========================================================
        CONTENIDO DEL FOOTER (CORREGIDO PARA MOBILE)
        ========================================================== --}}
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">

        {{-- FILA 1: COLUMNAS (EN MOBILE SE APILAN) --}}
        <div class="grid grid-cols-1 items-start gap-8 border-b border-ferro-carbon-700 pb-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="w-full text-left">
                ...
                <div class="flex max-w-xs flex-col items-stretch gap-2 sm:flex-row">
                    <input 
                        type="email" 
                        placeholder="Tu correo" 
                        class="w-full sm:flex-1 px-3 py-2 text-xs bg-ferro-carbon-800 border border-ferro-carbon-700 rounded-lg sm:rounded-l-lg sm:rounded-r-none focus:outline-none focus:ring-1 focus:ring-ferro-yellow-500 text-ferro-white placeholder-ferro-white/40"
                    >
                    <button class="w-full sm:w-auto px-4 py-2 text-xs font-heading font-semibold bg-ferro-yellow-500 hover:bg-ferro-yellow-600 text-ferro-black rounded-lg sm:rounded-r-lg sm:rounded-l-none transition-colors whitespace-nowrap">
                        Suscribir
                    </button>
                </div>

                {{-- REDES SOCIALES --}}
                <nav class="mt-4 flex items-center justify-start gap-4" aria-label="Redes sociales de FERRANOVA">
