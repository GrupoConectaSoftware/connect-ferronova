        ...
        <div class="flex items-center justify-between py-3 border-b border-ferro-carbon-100">
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <a href="{{ route('heart') }}" class="text-ferro-steel-700 hover:text-ferro-yellow-500 transition-colors relative"
                    :aria-label="`Favoritos (${$store.favorites.count})`" title="Favoritos">
                    ...
                    <span
                        class="absolute -top-1 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-ferro-yellow-500 px-1 text-[10px] font-bold text-ferro-black"
                        x-text="$store.favorites.count"></span>
                </a>

                {{-- Carrito --}}
                <a href="{{ route('cart') }}" class="text-ferro-steel-700 hover:text-ferro-yellow-500 transition-colors relative"
                    :aria-label="`Carrito de compras (${$store.cart.count})`" title="Carrito de compras">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
