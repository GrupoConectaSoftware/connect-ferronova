...
<body class="bg-ferro-background font-body text-ferro-carbon-700 antialiased">
    ...
    <main
        ...
        class="min-h-screen pt-8 sm:pt-10 lg:pt-12"
        aria-label="Detalle del producto"
    >
        <div class="container mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8 lg:pb-24">
            <button
                type="button"
                class="inline-flex items-center gap-2 px-1 py-2 text-sm font-semibold text-ferro-steel-500 transition-colors hover:text-ferro-carbon-900"
            ...
            <nav class="mb-8 mt-4 flex min-w-0 items-center gap-2 text-sm" aria-label="Migas de pan">
                ...
                <span class="text-ferro-steel-300">/</span>
                        ...
                        <div class="grid gap-0 lg:grid-cols-[1.02fr_0.98fr]">
                            ...
                            <div class="flex flex-col p-6 sm:p-8 lg:p-10">
                                ...
                                <a
                                    ...
                                    class="mt-3 flex items-center justify-center gap-2 rounded-xl bg-ferro-whatsapp px-5 py-3.5 text-sm font-bold text-white transition-colors hover:bg-[#20bd5a]"
                                >
